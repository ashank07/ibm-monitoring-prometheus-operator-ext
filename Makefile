...
IMG ?= ibm-monitoring-prometheusext-operator
...
IMAGE_NAME=$(IMG)
IMAGE_DISPLAY_NAME=IBM Monitoring Prometheus Extension Operator
IMAGE_MAINTAINER=dybo@cn.ibm.com
IMAGE_VENDOR=IBM
IMAGE_VERSION=$(VERSION)
IMAGE_DESCRIPTION=Operator used to install prometheus in a kubernetes cluster with some addons to https://github.com/coreos/prometheus-operator
