...
QUAY_REPOSITORY=${QUAY_REPOSITORY:-ibm-monitoring-prometheusext-operator-app}
BUNDLE_DIR=${BUNDLE_DIR:-deploy/olm-catalog/ibm-monitoring-prometheus-operator-ext}
